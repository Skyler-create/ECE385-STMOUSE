...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/timhs/OneDrive/Documents/Vivado/Final_Project/FPGA-SDcard-Reader-SPI-master/FPGA-SDcard-Reader-SPI-master/example-vivado-readfile/Nexys4-ReadFile.cache/compile_simlib/riviera"
  fi
